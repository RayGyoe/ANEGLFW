package com.vsdevelop.air.extension.glfw
{
	...
	public final class Glfw
	{
		...
		{
			checkSupported();
			var callName:String = "WindowSizeCallback_" + window_IntPtr;
			if (callback!=null){
		...
		{
			checkSupported();
			var callName:String = "CursorPosCallback_" + window_IntPtr;
			if (callback!=null){
				ANEGLFW.getInstance().actionScriptData.callback[callName] = callback;
			}else{
				callName = "";
		...
		{
			checkSupported();
			var callName:String = "MouseButtonCallback_" + window_IntPtr;
			if (callback!=null){
				ANEGLFW.getInstance().actionScriptData.callback[callName] = callback;
			}else{
				callName = "";
			...
			ANEGLFW.getInstance().context.call("glfwSetMouseButtonCallback", window_IntPtr, callName);
		}
