package ui.components
{
	 ...
	 */
	public class TextRenderer extends Container
	{
		// 文本属性
		...
		private function updateTextVertices():void
		{
			...
			// 计算文本的绝对位置 - 考虑父容器的坐标偏移
			var absolutePos:Object = getAbsolutePosition();
			var textX:Number = absolutePos.x;
			var textY:Number = absolutePos.y;
		...
		{
			return new Rectangle(0, 0, _textWidth, _textHeight);
		}
	}
}